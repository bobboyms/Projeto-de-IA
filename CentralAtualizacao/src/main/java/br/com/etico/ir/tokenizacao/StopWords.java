...
public class StopWords {
	...
	private static String STOPWORDS = "a, agora, ainda, alguém, algum, alguma, algumas, alguns, ampla, amplas, amplo, amplos, ante, antes, ao, aos,"
			...
			+ " todo, todos, tu, tua, tuas, tudo, última, últimas, último, últimos, um, uma, umas, uns, vendo, ver, vez, vindo, vir, vos, vós";
	...
	public List<String> tokenizador(StringBuilder stringBuilder) {
		...
		List<String> lisTokens = new ArrayList<>();
